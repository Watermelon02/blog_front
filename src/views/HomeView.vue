...
const getPassages = async() => {
    axios.get<Result<Array<Passage>>>('http://localhost:8080/passage/select', { params: { curPage: currentPage.value } }).then(function (response) {
...
<template>
    <div class="article-list" style="margin-top: 10vh;">
