...
import { isMobile } from "/Users/xigua/Desktop/vue/src/main";
...
<template>
  ...
  <el-card
    :class="isMobile ? 'blog-card-mobile' : 'blog-card-pc'"
    :body-style="{ padding: '0px' }"
    shadow="hover"
  >
    <a v-on:click="pushWithId"
      ><img
        :src="passage.data.cover"
        :class="isMobile ? 'image-mobile' : 'image-pc'"
    /></a>
    <div style="padding: 14px">
      ...
      <div class="bottom">
        <el-row>
          <el-col
            v-for="tag in passage.data.tags"
            :span="24 / passage.data.tags!.length"
          >
